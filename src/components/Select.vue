          ...
          <div class="row">
            ...
            <div class="col-5">
              ...
              <div class="group_seat">
                <p class="text-muted" style="text-align: center;font-size:18px;letter-spacing: 15px;">SCREEN</p>
                <hr>
            ...
            <div class="col-3 height">
              ...
              <div class="c1">
                <div class="c2">
                  ...
                  <div class="card card_select" style="margin-bottom: 10px; width:245px" v-for="(seat_s) in seat_select"
                    :key="seat_s.id">
                    <div style="border-radius: 12px;" v-bind:style="parseInt(seat_s.cos) < 180 ? {backgroundColor: '#b3cce6'} : {backgroundColor: 'rgb(153, 204, 255)'}"
                      class="card-body">
                      <h4>{{seat_s.num}}</h4>
